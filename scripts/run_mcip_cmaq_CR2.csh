...
set APPL       = 3km       # 3km, 9km
set CoordName  = LAM_23S_46W # LAM_23S_45W LAM_23S_46W   16-character maximum
set GridName   = MASP        # SP, MASP              16-character maximum

set DataPath   = $CMAQ_HOME/data/CR2 
set DataProj   = $HOME/projects/CR2/data
set InMetDir   = $DataProj/wrfout
set InGeoDir   = $DataProj/geo
set OutDir     = $DataPath/met/mcip
...
set InMetFiles = ( $InMetDir/wrfout_${D0x}_2024-08-26_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-08-27_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-08-28_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-08-29_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-08-30_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-08-31_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-01_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-02_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-03_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-04_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-05_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-06_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-07_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-08_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-09_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-10_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-11_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-12_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-13_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-14_00:00:00 \
                   $InMetDir/wrfout_${D0x}_2024-09-15_00:00:00 )

set IfGeo      = "T"
set InGeoFile  = $InGeoDir/geo_em.${D0x}.nc
...
set TOMG = `date -ud "${TODAYG}+1days" +%Y-%m-%d` #> Add a day for tomorrow
set MCIP_START = ${TODAYG}-00:00:00.0000  # [UTC]
set MCIP_END   = ${TOMG}-00:00:00.0000  # [UTC]
...
setenv GRID_BDY_2D          $OutDir/GRIDBDY2D_${APPL}_$TODAYG.nc
setenv GRID_CRO_2D          $OutDir/GRIDCRO2D_${APPL}_$TODAYG.nc
setenv GRID_DOT_2D          $OutDir/GRIDDOT2D_${APPL}_$TODAYG.nc
setenv MET_BDY_3D           $OutDir/METBDY3D_${APPL}_$TODAYG.nc
setenv MET_CRO_2D           $OutDir/METCRO2D_${APPL}_$TODAYG.nc
setenv MET_CRO_3D           $OutDir/METCRO3D_${APPL}_$TODAYG.nc
setenv MET_DOT_3D           $OutDir/METDOT3D_${APPL}_$TODAYG.nc
setenv LUFRAC_CRO           $OutDir/LUFRAC_CRO_${APPL}_$TODAYG.nc
setenv SOI_CRO              $OutDir/SOI_CRO_${APPL}_$TODAYG.nc
setenv MOSAIC_CRO           $OutDir/MOSAIC_CRO_${APPL}_$TODAYG.nc
