...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = CR2               #> Application Name (e.g. Gridname)
 set METAPPL   = 3km               #> MCIP application Name 
 set SCEN      = BASE              #> Emission scenario (BASE or BAU)
 set VOUT      = v01               #> Simulation version

#> Define RUNID as any combination of parameters above or others. By default,
#> this information will be collected into this one string, $RUNID, for easy
#> referencing in output binaries and log files as well as in other scripts.
 set RUNID = ${VRSN}_${compilerString}_${APPL}
 set RUNNA = ${VRSN}_${SCEN}_${APPL}
...
#> Set working, input and output directories
 ...
 set CCTMOUTDIR = ${CMAQ_DATA}/output_CCTM_${RUNNA}      #> CCTM Output Directory
...
#> Set Start and End Days for looping
 set START_DATE = "2024-08-28"     #> beginning date (July 1, 2016)
 set END_DATE   = "2024-09-14"     #> ending date    (July 14, 2016)
...
#> Loop through all days between START_DAY and END_DAY
 ...
 while ($TODAYJ <= $STOP_DAY )  #>Compare dates in terms of YYYYJJJ
  ...
  #> A new file will be created for each month/year.
   setenv OUTFILE ${POSTDIR}/COMBINE_ACONC_${RUNID}_${SCEN}${VOUT}_$YYYY$MM.nc
  ...
  #> File [4]: MCIP METCRO2D file
   ...
   setenv INFILE2 $METDIR/METCRO3D_${METAPPL}_${YYYY}-${MM}-${DD}.nc
   setenv INFILE3 $CCTMOUTDIR/CCTM_AELMO_${RUNID}_$YYYY$MM$DD.nc
   setenv INFILE4 $METDIR/METCRO2D_${METAPPL}_${YYYY}-${MM}-${DD}.nc
...
#> Loop through all days between START_DAY and END_DAY
 ...
 while ($TODAYJ <= $STOP_DAY )  #>Compare dates in terms of YYYYJJJ
  ...
  #> A new file will be created for each month/year.
   setenv OUTFILE ${POSTDIR}/COMBINE_DEP_${RUNID}_${SCEN}${VOUT}_$YYYY$MM
  ...
  #> File [4]: {empty}
   ...
   setenv INFILE3 $METDIR/METCRO2D_${METAPPL}_${YYYY}-${MM}-${DD}.nc
   setenv INFILE4
