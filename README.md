...
El curso aborda los fundamentos de la calidad del aire, el uso de observaciones, la evaluación de los modelos numéricos de química atmosférica, así como sus requisitos y aplicaciones en América Latina y el Caribe. El contenido del curso servirá de base para el desarrollo de sistemas de pronóstico y de diseño de políticas basados en resultados de simulación validados con observaciones en superficie y en altura. 

## Contenido del curso
* Fundamentos y fenómenos de la calidad del aire
* Observaciones de calidad del aire: redes in situ y satélites
* Evaluación de modelos con observaciones
* Modelos numéricos de química atmosférica: requisitos y aplicaciones en América Latina y el Caribe

## Módulo de evaluación de modelos
* Las observaciones ya fueron descargadas para São Paulo y corresponden a la Compañía Ambiental del Estado de São Paulo (CETESB) de agosto y setiembre de 2024. Las mediciones corresponden al material particulado fino menor de 2.5 µm (PM2.5), monóxido de carbono (CO), óxidos de nitrógeno (NOx) y ozono (O3) de diferentes estaciones de calidad del aire ubicadas en la Región Metropolitana de São Paulo (RMSP) y en el estado de São Paulo. Las estaciones representan diferentes regímenes de calidad del aire: urbano, residencial, regional urbano e industrial.

## Referencias
Brasseur, Guy P. 2025. The Air and Its Secrets: A History of Atmospheric Science. Edp sciences. Max Planck Institute and National Center for Atmospheric Research. https://doi.org/10.1051/978-2-7598-3820-2
